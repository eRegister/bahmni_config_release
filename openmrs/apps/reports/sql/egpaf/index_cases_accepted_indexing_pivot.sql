...
(SELECT CLIENTS_OFFERED_INDEXING_ROWS.age_group AS 'AgeGroup'  
						...
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Routine' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Routine_VL_Accepted_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Routine' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Routine_VL_Accepted_Females 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Routine' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Routine_VL_Denied_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Routine' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Routine_VL_Denied_Females 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Targeted' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Targeted_VL_Accepted_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Targeted' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Targeted_VL_Accepted_Females 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Targeted' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Targeted_VL_Denied_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status > 20 AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HVL_Targeted' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Targeted_VL_Denied_Females  
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Linked_Accepted_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Linked_Accepted_Females  
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Linked_Denied_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Linked_Denied_Females   
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Not_Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Not_Linked_Accepted_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Not_Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Not_Linked_Accepted_Females  
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Not_Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Not_Linked_Denied_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Not_Linked' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Not_Linked_Denied_Females  
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Referred' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Referred_Accepted_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Referred' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Accepted' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Referred_Accepted_Females  
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Referred' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'M', 1, 0))) AS Referred_Denied_Males 
						, IF(CLIENTS_OFFERED_INDEXING_ROWS.Id IS NULL, 0, SUM(IF(CLIENTS_OFFERED_INDEXING_ROWS.Patient_Health_Status = 'Referred' AND CLIENTS_OFFERED_INDEXING_ROWS.Client_Program = 'HTS' AND CLIENTS_OFFERED_INDEXING_ROWS.Indexing = 'Denied' AND CLIENTS_OFFERED_INDEXING_ROWS.Gender = 'F', 1, 0))) AS Referred_Denied_Females  
