...
FROM (
			...
			FROM (
					...
					(SELECT Id, patientIdentifier AS "Patient Identifier", patientName AS "Patient Name", Age, Gender, age_group, HIV_Status, 'PITC' AS 'HIV_Testing_Initiation', sort_order
					FROM
									...
									from obs o
											-- HTS CLIENTS WITH HIV STATUS BY SEX AND AGE
											 ...
											 -- MALNUTRITION, MODE OF ENTRY POINT
											 AND o.person_id in (
												select distinct os.person_id
												from obs os
