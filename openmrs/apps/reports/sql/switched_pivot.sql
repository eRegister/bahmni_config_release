...
FROM (
			...
			FROM (
					...
					(SELECT Id, patientIdentifier AS "Patient Identifier", patientName AS "Patient Name", Age, Gender, age_group, HIV_Status, 'switched' AS 'Treatment_Switch', sort_order
					FROM
							 ...
							 -- Switched
								 AND o.person_id in (
									...
									from obs os
									where os.concept_id = 4158 and os.value_coded =  2146
	 ...
	 UNION ALL
			...
			FROM (
					...
					(SELECT Id, patientIdentifier AS "Patient Identifier", patientName AS "Patient Name", HIV_Status, 'switched' AS 'Treatment_Switch'
