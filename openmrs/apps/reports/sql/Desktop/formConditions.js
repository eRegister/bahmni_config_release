Bahmni.ConceptSet.FormConditions.rules = {
		...
		} else if (!anySurgery || Surgery != "Yes") {
        ...
        'HIV, Testing Strategies': function (formName, formFieldValues){
                ...
                if (formName ==  "HIV Testing and Counseling Intake Template") {
                        if (TestingStrategies == "HIVTC, Rapid Test") {
                                ...
                                conditions.show.push("HTC, Pre-test Counseling Set", "HTC, HIV Test", "HTC, Post-test Counseling Set","HIVTC, TB Screened", "HTS, Referral", "ART, Condoms Dispensed")
        
                                

                        }else if (TestingStrategies == "HIVTC, Self Test") {
                                conditions.hide.push("HTC, Pre-test Counseling Set", "HTC, HIV Test", "HTC, Post-test Counseling Set","HIVTC, TB Screened", "HTS, Referral", "ART, Condoms Dispensed")
                                ...
                                conditions.hide.push("HTC, Pre-test Counseling Set", "HTC, HIV Test", "HTC, Post-test Counseling Set","HIVTC, TB Screened", "HTS, Referral", "ART, Condoms Dispensed", "HTC, Date Of Distribution", "HTC, Distribution channel", "HTC, Distribution Mode", "HTC, Kit Collected For", "HTC, Key Pop", "HTC, Tested for HIV in The Past 12 Months", "HTC, HIVST Results")  
                        }
                        
                }
                return conditions;
        },
        'Typ0e of client': function (formName, formFieldValues, patient) {
