...
FROM
        (
			SELECT distinct patient.patient_id AS Id,
											   ...
											   'Missed Within 28 Days' AS App_Status
			from obs o
				...
				and o.person_id not in (
						 ...
						 INNER JOIN person p ON p.person_id = patient.patient_id AND person.voided = 0
						 INNER JOIN person_name pn ON person.person_id = pn.person_id AND pn.preferred = 1
